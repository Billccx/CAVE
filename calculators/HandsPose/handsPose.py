...
class HandsPose(BaseCalculator):
    def __init__(self):
        ...
        self.parser.add_argument('--model_path', type=str, default='/home/cuichenxi/code/Python/Pipeline/calculators/HandsPose/weights/resnet_50-size-256-wingloss102-0.119.pth',
    ...
    def Process(self,img,**kwargs):
        ...
        with torch.no_grad():
            ...
            if len(handsresult.result):
                ...
                result.setResult([self.pts_hand['9']['x'],self.pts_hand['9']['y']])
